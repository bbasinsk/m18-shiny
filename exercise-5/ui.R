...
shinyUI(fluidPage(
  ...
  titlePanel("Thoughts on Gender Roles"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      #inputID = sex
      selectInput('sex', 'Men', list('Men' = 'Men', 'Women' = 'Women', 'Both' = 'Both')),
      
      #selectInput for Agree or Disagree
      #inputID = thoughts
      selectInput('thoughts', 'Agree', list('Agree' = 'agree', 'Disagree' = 'disagree'))
